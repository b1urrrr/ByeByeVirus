...
public class GameManager_Stage7 : MonoBehaviour
{
    ...
    void Update()
    {
        if (currentPos == 5) // 목적지 도달
        {
            ...
            if (countPatient == 0)
            {
                ...
                if (min < 1 && sec < 30)
                {
                    this.StarManager._numberOfStar[7] = 3;
                    threeStar.SetActive(true);
                }
                else if (min < 1)
                {
                    if (this.StarManager._numberOfStar[7] < 2)
                        this.StarManager._numberOfStar[7] = 2;
                    twoStar.SetActive(true);
                }
                else
                {
                    if (this.StarManager._numberOfStar[7] < 1)
                        this.StarManager._numberOfStar[7] = 1;
